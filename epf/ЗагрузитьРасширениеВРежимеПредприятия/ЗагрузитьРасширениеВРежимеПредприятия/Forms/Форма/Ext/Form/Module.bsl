...
Процедура ПриОткрытии(Отказ)
	...
	Попытка
		...
		ИспользоватьОсновныеРолиДляВсехПользователей  = ЗначениеПараметраБулево("ОтключитьЛогикуНачалаРаботыСистемы", 
	...
	Попытка
		...
		ЗагрузитьРасширения(ПутьРасширения, ИмяРасширения, Перезаписывать, 
			...
			ЗавершитьРаботуСистемы, ОтключитьЛогикуНачалаРаботыСистемы, ИспользоватьОсновныеРолиДляВсехПользователей);
...
Процедура ЗагрузитьРасширения(ПутьРасширения, Знач ИмяРасширения, Перезаписывать, 
	...
	ДопПараметры.Вставить("ИспользоватьОсновныеРолиДляВсехПользователей", ИспользоватьОсновныеРолиДляВсехПользователей);
...
Процедура ОбработкаПоискаРасширенийВКаталоге(Знач НайденныеФайлы, Знач ДопПараметры) Экспорт
	...
	Попытка
		...
		ИспользоватьОсновныеРолиДляВсехПользователей = ДопПараметры.ИспользоватьОсновныеРолиДляВсехПользователей;
		...
		Для Каждого Файл Из НайденныеФайлы Цикл
			...
			Попытка
				УстановитьРасширение(ИмяРасширения, ДвоичныеДанные, Перезаписывать, 
					БезопасныйРежим, ЗащитаОтОпасныхДействий, ИспользоватьОсновныеРолиДляВсехПользователей);
			Исключение
...
Процедура УстановитьРасширение(Имя, ДвоичныеДанныеРасширения, Перезаписывать, 
	...
	Если Версия8315ИлиВыше() Тогда
		Расширение.ИспользоватьОсновныеРолиДляВсехПользователей = ИспользоватьОсновныеРолиДляВсехПользователей;
	КонецЕсли;
	...
	Исключение
		...
		УстановитьРасширение(Имя, ДвоичныеДанныеРасширения, Перезаписывать,
			БезопасныйРежим, ЗащитаОтОпасныхДействий, ИспользоватьОсновныеРолиДляВсехПользователей, Истина);
