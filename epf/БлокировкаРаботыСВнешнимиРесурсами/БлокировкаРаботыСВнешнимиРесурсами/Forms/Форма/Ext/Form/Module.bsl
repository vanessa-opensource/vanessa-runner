...
Процедура ЗапуститьОбработкуПараметров()
	...
	Если МассивПараметров.Количество() > 1 И (ОтключитьРегламентноеЗадание Или ВключитьРегламентноеЗадание) Тогда 
		НаименованиеРегламентногоЗадания = СокрЛП(МассивПараметров[1]);	
		УстановитьИспользованиеРегламентногоЗадания(ВключитьРегламентноеЗадание);	
	КонецЕсли;	
...
Процедура УстановитьИспользованиеРегламентногоЗадания(Использование)
	...
	Для Каждого РегламентноеЗадание Из СписокЗаданий Цикл
		...
		Если Использование Тогда
			ТекстСообщения = СтрШаблон(НСтр("ru = 'Включено регламентное задание: %1'"), РегламентноеЗадание.Наименование);
		Иначе
