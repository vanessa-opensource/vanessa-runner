...
Функция СоздатьПервогоАдминистратораПриНеобходимости(Имя)
	...
	Администратор.ЗащитаОтОпасныхДействий = ОписаниеЗащиты;
	...
	Если Метаданные.Роли.Найти("АдминистраторСистемы") <> Неопределено Тогда
		Администратор.Роли.Добавить(Метаданные.Роли.АдминистраторСистемы);
	КонецЕсли;
	
	Если Метаданные.Роли.Найти("ИнтерактивноеОткрытиеВнешнихОтчетовИОбработок") <> Неопределено Тогда
		Администратор.Роли.Добавить(Метаданные.Роли.ИнтерактивноеОткрытиеВнешнихОтчетовИОбработок);
	КонецЕсли;
