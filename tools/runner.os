...
Процедура ОсновнаяРабота()
	...
	Попытка
		...
		ОбщиеМетоды.ДополнитьАргументыИзПеременныхОкружения(Аргументы.ЗначенияПараметров, СоответствиеПеременных, Лог);
		...
		КонецЕсли;
		 ...
		 // TODO строки ниже по ПрочитатьНастройкиФайлJSON и т.п. перенести в main.os
