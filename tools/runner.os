...
Процедура ОсновнаяРабота()
	...
	Попытка
		...
		ОбщиеМетоды.ДополнитьАргументыИзПеременныхОкружения(Аргументы.ЗначенияПараметров, СоответствиеПеременных);
		...
		Если НастройкиИзФайла.Количество() > 0 Тогда 
			ОбщиеМетоды.ДополнитьАргументыИзФайлаНастроек(Команда, Аргументы.ЗначенияПараметров, НастройкиИзФайла);
		КонецЕсли;
