...
Большинство подкоманд `repo` работают с информационной базой и хранилищем. Строка подключения и опции СУБД описаны на странице [Подключение к базе данных](./05-common-options).
...
> [Подключение к базе данных →](./05-common-options)
