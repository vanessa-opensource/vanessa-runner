...
Каталог исходников - EDT-проект или XML-выгрузка Конфигуратора. XML-выгрузка перед проверкой конвертируется во временный EDT-проект (`1cedtcli import`); имя проекта в отчёте - имя каталога исходников.
...
| Опция | Переменная окружения | Описание |
|-------|---------------------|----------|
| `--src`, `-s` | `VRUNNER_SRC` | Каталог EDT-проекта или XML-выгрузки Конфигуратора (по умолчанию - текущий) |
