...
| Аргумент | Описание |
|----------|----------|
| `OUT` | Путь к создаваемому файлу расширения (`.cfe`) (**обязательный**, в файле настроек — ключ `out`) |
...
| Аргумент | Описание |
|----------|----------|
| `OUT` | Каталог для выгрузки XML-исходников расширения (**обязательный**, в файле настроек — ключ `out`) |
...
| Аргумент | Описание |
|----------|----------|
| `SRC` | Каталог XML-исходников или путь к CFE-файлу (по умолчанию — текущий каталог; в файле настроек — ключ `src`) |
...
| Аргумент | Описание |
|----------|----------|
| `OUT` | Путь к создаваемому CFE-файлу (**обязательный**, в файле настроек — ключ `out`) |
...
| Аргумент | Описание |
|----------|----------|
| `OUT` | Каталог для результата конвертации (**обязательный**, в файле настроек — ключ `out`) |
