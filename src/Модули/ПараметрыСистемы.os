...
Функция ВозможныеКоманды() Экспорт
	...
	Если мВозможныеКоманды = Неопределено Тогда
		...
		мВозможныеКоманды.Вставить("ОбновитьКонфигурациюНаПоддержке", "update");
...
Процедура ПриРегистрацииКомандПриложения(Знач КлассыРеализацииКоманд) Экспорт
	...
	КлассыРеализацииКоманд[ВозможныеКоманды().ОбновитьКонфигурациюНаПоддержке] = "КомандаОбновитьКонфигурациюНаПоддержке";
