...
Процедура ПриРегистрацииГлобальныхПараметровКоманд(Знач Парсер) Экспорт
	...
	Парсер.ДобавитьИменованныйПараметр("--v8-platform-path",
		"Путь к каталогу установки платформы 1С", Истина);
	Парсер.ДобавитьИменованныйПараметр("--v8-exe-name",
		"Имя исполняемого файла платформы для Конфигуратора/толстого клиента", Истина);
	Парсер.ДобавитьИменованныйПараметр("--v8c-exe-name",
		"Имя исполняемого файла тонкого клиента", Истина);
	Парсер.ДобавитьИменованныйПараметр("--ibcmd-exe-name",
		"Имя исполняемого файла ibcmd (например, ibcmd.exe)", Истина);
