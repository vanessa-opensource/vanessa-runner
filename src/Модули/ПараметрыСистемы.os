...
Функция ВерсияПродукта() Экспорт
	...
	Версия = "1.10.2"; // присвоение "Версия = " важно для проверки Сонара
	Возврат Версия;
...
Функция ВозможныеКоманды() Экспорт
	...
	Если мВозможныеКоманды = Неопределено Тогда
		...
		мВозможныеКоманды.Вставить("СоздатьИнформационнуюБазу","dbcreate");
		мВозможныеКоманды.Вставить("УдалитьИнформационнуюБазу","dbremove");
