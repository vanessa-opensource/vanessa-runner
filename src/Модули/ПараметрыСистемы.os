...
Функция ВерсияПродукта() Экспорт
	...
	Версия = "1.4.1";// присвоение "Версия = " важно для проверки Сонара
	Возврат Версия;
...
Функция ВозможныеКоманды() Экспорт
	...
	Если мВозможныеКоманды = Неопределено Тогда
		...
		мВозможныеКоманды.Вставить("РазаборкаКонфигурации", "decompile");
...
Процедура ПриРегистрацииКомандПриложения(Знач КлассыРеализацииКоманд) Экспорт
	...
	КлассыРеализацииКоманд[ВозможныеКоманды().РазаборкаКонфигурации]	= "КомандаРазборкаКонфигурации";
