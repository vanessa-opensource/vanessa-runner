...
Функция ВерсияПродукта() Экспорт
	...
	Версия = "0.13.2";// присвоение "Версия = " важно для проверки Сонара
	Возврат Версия;
...
Функция ВозможныеКоманды() Экспорт
	...
	Если мВозможныеКоманды = Неопределено Тогда
		...
		мВозможныеКоманды.Вставить("ПроверкаКонфигурации", "checkconfig");		
...
Процедура ПриРегистрацииКомандПриложения(Знач КлассыРеализацииКоманд) Экспорт
	...
	КлассыРеализацииКоманд[ВозможныеКоманды().ПроверкаКонфигурации]	= "КомандаПроверкаКонфигурации";
