...
Функция ВерсияПродукта() Экспорт
	...
	Версия = "0.12.0";// присвоение "Версия = " важно для проверки Сонара
	Возврат Версия;
...
Процедура ПриРегистрацииГлобальныхПараметровКоманд(Знач Парсер) Экспорт
	...
	Парсер.ДобавитьИменованныйПараметр("--ordinaryapp", 
		...
		Истина);
	// Парсер.ДобавитьИменованныйПараметр("--usecache", "Использовать кэш платформы для ускорения операций с базой 
	// 	|(1 = использовать, 0 - не использовать), по умолчанию 1", Истина);
