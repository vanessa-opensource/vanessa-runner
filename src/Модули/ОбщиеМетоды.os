...
Функция ВыполнитьКомандуСУчетомIbsrv(ПараметрыКоманды, Действие) Экспорт

	Если ИспользоватьIbsrv(ПараметрыКоманды) Тогда
		Возврат ВыполнитьЧерезIbsrv(ПараметрыКоманды, Действие);
	Иначе
...
Функция ВыполнитьЧерезIbsrv(ПараметрыКоманды, Действие) 
