...
//Получает одно из значений ключа, которое не Неопределенно
//	Параметры:
...
Функция ПолучитьПараметры(Параметры, Ключ1, Ключ2) Экспорт
	// Возврат ?(Параметры[Ключ1] = Неопределено, Параметры[Ключ2], Параметры[Ключ1]);
	Возврат Параметр(Параметры, Ключ1, Параметры[Ключ2]);
КонецФункции

//Получает значение ключа или значение по умолчанию, если значение ключа = Неопределенно
//	Параметры:
//		Параметры - Соответствие 
//		Ключ1 - Строка - ключ соответствия
