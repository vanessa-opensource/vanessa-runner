...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	ОписаниеКоманды = Парсер.ОписаниеКоманды(ПараметрыСистемы.ВозможныеКоманды().СоздатьПользователейХранилища, 
		ТекстОписания);
	...
	Парсер.ДобавитьИменованныйПараметрКоманды(ОписаниеКоманды, "--storage-role", "Коллекция устанавливаемых ролей через запятую:
...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	РолиПользователя = ПараметрыКоманды["--storage-role"];
	...
	Попытка
		МенеджерКонфигуратора.СоздатьПользователяХранилища(
			...
			ЛогинПользователя, ПарольПользователя, РолиПользователя);
	Исключение
