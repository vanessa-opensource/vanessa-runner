...
Попытка
	...
	// Получение всех изменений из хранилища перед захватом требуется только если передан список объектов для захвата
	Если ЗначениеЗаполнено(ПараметрыКоманды["--objects"]) Тогда
