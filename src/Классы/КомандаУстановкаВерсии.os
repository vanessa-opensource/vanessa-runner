...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	Парсер.ДобавитьИменованныйПараметрКоманды(ОписаниеКоманды, "--src",
		"Путь Configuration.xml или Configuration.mdo или каталога, содержащего любой из этих файлов, или корневого каталога для поиска в подкаталогах - для исходников конфигурации или расширения");
