...
Функция РазобратьФайлВнешняяОбработка(Знач Файл, Знач КаталогВыгрузки, Знач КаталогКорень, Знач ВыводитьСообщения,
	...
	ОтносительныйПутьКаталога = ФС.ОтносительныйПуть(ТекущийКаталог(), КаталогВыгрузки);
	...
	Исключение
		...
		СтрокаБлокировкиКонфигуратора = "Ошибка блокировки информационной базы для конфигурирования";
		Если СтрНайти(ОписаниеОшибки, СтрокаБлокировкиКонфигуратора) Тогда
...
Функция РазобратьФайлВнутрВнешняяОбработка(Знач Файл, Знач КаталогВыгрузки, Знач КаталогКорень, 
	...
	ОтносительныйПутьКаталогаФайла = ФС.ОтносительныйПуть(КаталогКорень, ОбъединитьПути(Файл.Путь, Файл.ИмяБезРасширения));
	Лог.Отладка("ОтносительныйПутьКаталогаФайла <"+ОтносительныйПутьКаталогаФайла+">");
