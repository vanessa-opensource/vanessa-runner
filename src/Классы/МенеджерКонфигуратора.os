...
//
Функция ЗапуститьВРежимеПредприятияСПроверкойВыполнения(
				Знач ДопСообщения,
	...
	Если ЗначениеЗаполнено(ПутьКФайлуСтатусаВыполнения) Тогда
		...
		Если СтатусВозврата = "0" Тогда
			...
			Возврат РезультатыКоманд.Успех;
		...
		ИначеЕсли СтатусВозврата = "1" Тогда
			...
			Лог.Ошибка(Сообщение, ДопСообщения.СообщениеВСлучаеПадения, ЛогОт1С);
			Возврат РезультатыКоманд.Ошибка;
		...
		ИначеЕсли СтатусВозврата = "2" Тогда
			...
			Лог.Предупреждение(Сообщение, ДопСообщения.СообщениеВСлучаеПропуска, ЛогОт1С);
			Возврат РезультатыКоманд.Успех;
