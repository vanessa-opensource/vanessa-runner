...
//   ИмяРасширения (необязательно) - <Строка> - <описание параметра>
//
Процедура СоздатьХранилище(
			Знач ПутьХранилища, Знач ЛогинАдминистратора, Знач ПарольАдминистратора,
			Знач ПодключитьБазуКхранилищу = Ложь, Знач ИмяРасширения = "") Экспорт
	...
	Параметры.Добавить("/ConfigurationRepositoryN """+ЛогинАдминистратора+"""");

	Если Не ПустаяСтрока(ПарольАдминистратора) Тогда
		Параметры.Добавить("/ConfigurationRepositoryP """+ПарольАдминистратора+"""");
	КонецЕсли;
	...
	Если Не ПустаяСтрока(ИмяРасширения) Тогда
		Параметры.Добавить("-Extension """+ИмяРасширения+"""");
		ТекстНачалаОперации		= "Выполняю создание хранилища расширения "+ИмяРасширения;
		ТекстОкончанияОперации	= "Создание хранилища расширения завершено";
	Иначе
		ТекстНачалаОперации		= "Выполняю создание хранилища конфигурации";
		ТекстОкончанияОперации	= "Создание хранилища конфигурации завершено";
	КонецЕсли;
...
//   ИмяРасширения (необязательно) - <Строка> - <описание параметра>
//
Процедура ПодключитьсяКХранилищу(Знач ПутьХранилища, Знач ЛогинАдминистратора, Знач ПарольАдминистратора,
...
КонецПроцедуры // СоздатьФайлПоставки
