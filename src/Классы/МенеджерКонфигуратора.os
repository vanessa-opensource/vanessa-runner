...
Процедура РазобратьНаИсходникиТекущуюКонфигурацию(КаталогВыгрузки, Знач ФайлВерсии = "",
	...
	ТолькоИзмененые = (ТолькоИзмененые И ФайлОбъект.Существует());
	ИспользоватьПереименования = ?(ТолькоИзмененые, Ложь, ИспользоватьПереименования);
	УправлениеКонфигуратором.ВыгрузитьКонфигурациюВФайлы(КаталогРаспаковки, , ТолькоИзмененые, ФайлВерсии);
...
Процедура ВыгрузитьКонфигурациюВИсходники(Знач ФайлКонфигурации, Знач ВыходнойКаталог, 
	...
	ТолькоИзмененые = (ЗначениеЗаполнено(ФайлВерсии) И Новый Файл(ФайлВерсии).Существует());
	...
	Сообщить("Загружаю кофнигурацию "+ ФайлКонфигурации);
	УправлениеКонфигуратором.ЗагрузитьКонфигурациюИзФайла(ФайлКонфигурации, Ложь);
	РазобратьНаИсходникиТекущуюКонфигурацию(ВыходнойКаталог, ФайлВерсии, ТолькоИзмененые, ИспользоватьПереименования);
