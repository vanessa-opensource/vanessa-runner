...
Процедура ПоказатьСписокВсехРасширенийКонфигурации(НовыйУправлениеКонфигуратором = Неопределено) Экспорт
	Если НовыйУправлениеКонфигуратором = Неопределено Тогда
		УправлениеКонфигуратором = Новый УправлениеКонфигуратором();
	Иначе
		УправлениеКонфигуратором = НовыйУправлениеКонфигуратором;
	КонецЕсли;
