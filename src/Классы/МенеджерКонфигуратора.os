...
Процедура СоздатьФайловуюБазу(Знач КаталогБазы, Знач ПутьКШаблону = "",
	...
	ПараметрыЗапуска.Добавить("/Out""" +УправлениеКонфигуратором.ФайлИнформации() + """");
	Если ЗначениеЗаполнено(КодЯзыка) Тогда
	...
	РезультатСообщение = ОбщиеМетоды.ПрочитатьФайлИнформации(УправлениеКонфигуратором.ФайлИнформации());
