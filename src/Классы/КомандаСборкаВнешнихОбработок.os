...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	ТекстОписания = 
		"     собираем внешние обработки из исходников штатно через выгрузку 1С 8.3
	...
	ОписаниеКоманды = Парсер.ОписаниеКоманды(ПараметрыСистемы.ВозможныеКоманды().СборкаВнешнихОбработок, ТекстОписания);
