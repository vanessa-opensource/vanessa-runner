...
//   Число - Результат выполнения команды (exitCode)
//
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	Попытка
		РезультатКоманды = ЗапуститьТестироватьЮнит(
			ПолныйПуть,
...
//  ПутьККонфигурационномуФайлу - Строка - Путь к конфигурационному файлу xUnitFor1c
//  ОжидатьЗавершения -  Булево - Ожидать завершения запуска
...
//   Число - Результат выполнения команды (exitCode)
//
Функция ЗапуститьТестироватьЮнит(Знач ПутьВходящихДанных,
	...
	РезультатКоманды = МенеджерКонфигуратора.ЗапуститьВРежимеПредприятияСПроверкойВыполнения(
		ДопСообщения,
