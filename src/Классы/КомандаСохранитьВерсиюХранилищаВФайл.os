...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	ТекстОписания = 
		"     Сохранить версию хранилища в файл cf.
		|     ";

	ОписаниеКоманды = Парсер.ОписаниеКоманды(ПараметрыСистемы.ВозможныеКоманды().СохранитьВерсиюХранилищаВФайл, 
		ТекстОписания);
...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	Попытка
		МенеджерКонфигуратора.ВыгрузитьВерсиюХранилищаВФайл(
