...
Попытка
	...
	Лог.Отладка("Перед удалением временных файлов!");
	ВременныеФайлы.Удалить();
	
	Лог.Отладка("Завершили ванесса-раннер!");
	ЗавершитьРаботу(КодВозврата);
		
Исключение
		
	Лог.КритичнаяОшибка(ОписаниеОшибки());
	Лог.Отладка("Перед удалением временных файлов в блоке исключения!");
	ВременныеФайлы.Удалить();

	Лог.Отладка("Завершили ванесса-раннер в блоке исключения!");
