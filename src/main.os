...
Исключение
	...
	ПолныйТекстОшибки = ПодробноеПредставлениеОшибки(ИнфоОшибки);
	ПолныйТекстОшибки = ПолныйТекстОшибки  + ОбщиеМетоды.СтекВызовов();
	...
	Если ЗначениеЗаполнено(ИнфоОшибки.Параметры) Тогда
		...
		Лог.Информация(ПолныйТекстОшибки);
	Иначе
		Лог.КритичнаяОшибка(ПолныйТекстОшибки);
	КонецЕсли;
