...
Сценарий: Инициализация рабочей базы по умолчанию в ./build/ib
    ...
    Когда Я выполняю команду "oscript" c параметрами "<КаталогПроекта>/tools/init.os init-dev --src ./cf "
...
Сценарий: Инициализация сервисной базы по умолчанию в ./build/ibservice
    ...
    Когда Я выполняю команду "oscript" c параметрами "<КаталогПроекта>/tools/init.os init-dev --src ./cf --dev"
    И Я сообщаю вывод команды "oscript"
...
Сценарий: Инициализация рабочей базы в отдельном каталоге
    ...
    Когда Я выполняю команду "oscript" c параметрами "<КаталогПроекта>/tools/init.os init-dev --src ./cf --ibname /Fbuild/base1"
    И Я сообщаю вывод команды "oscript"
    Тогда Вывод команды "oscript" содержит "Обновление конфигурации базы данных успешно завершено"
    И Код возврата команды "oscript" равен 0
...
Сценарий: Инициализация сервисной базы в отдельном каталоге
    ...
    Когда Я выполняю команду "oscript" c параметрами "<КаталогПроекта>/tools/init.os init-dev --src ./cf --dev  --ibname /Fbuild/base2"
    И Я сообщаю вывод команды "oscript"
    Тогда Вывод команды "oscript" не содержит "Обновление конфигурации базы данных"
    И Код возврата команды "oscript" равен 0
