...
Сценарий: Сборка одного расширения с явно заданной базой
    ...
    Когда Я выполняю команду "oscript" c параметрами "<КаталогПроекта>/src/main.os compileext cfe РасширениеНовое1 --ibconnection /F./build/ib"
...
Сценарий: Сборка одного расширения и сохранение в файл с явно заданной базой
    ...
    Допустим каталог "epf" не существует
    Когда Я выполняю команду "oscript" c параметрами "<КаталогПроекта>/src/main.os compileexttocfe -s cfe -o РасширениеНовое1.cfe --ibconnection /F./build/ib"
    Тогда Я сообщаю вывод команды "oscript"
    Тогда Код возврата команды "oscript" равен 0
...
Сценарий: Сборка одного расширения и сохранение в файл без базы
    ...
    Допустим каталог "epf" не существует
    Когда Я выполняю команду "oscript" c параметрами "<КаталогПроекта>/src/main.os compileexttocfe -s cfe -o РасширениеНовое1.cfe"
    Тогда Я сообщаю вывод команды "oscript"
    Тогда Код возврата команды "oscript" равен 0
