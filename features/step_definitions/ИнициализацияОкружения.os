...
Функция ПолучитьСписокШагов(КонтекстФреймворкаBDD) Экспорт
	...
	ВсеШаги.Добавить("ЯвСпискеБазЕстьБазаПоПути");
	ВсеШаги.Добавить("ЯвспискебазнахожубазудляПроекта");
...
Процедура ЯвСпискеБазЕстьБазаПоПути(СтрокаБазыДанных) Экспорт
	...
	Ожидаем.Что(ОбщиеМетоды.ПолучитьИмяБазыВСписке("/F"+СтрокаБазыДанных), "").Равно(Новый Файл(БДД.ПолучитьИзКонтекста("РабочийКаталог")).ИмяБезРасширения);
	
КонецПроцедуры

Процедура Явспискебазнахожубазудляпроекта(СтрокаПутиБазы) Экспорт
	...
	Парсер = ОбщиеМетоды.ПолучитьПарсерБаз();
