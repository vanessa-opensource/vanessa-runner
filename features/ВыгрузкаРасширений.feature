...
Сценарий: Выгрузка одного расширения из базы
    ...
    Когда Я выполняю команду "oscript" c параметрами "<КаталогПроекта>/src/main.os unloadext cfe-out/РасширениеНовое1.cfe РасширениеНовое1 --ibconnection /F./build/ib"
    Тогда Код возврата равен 0
    И Файл "./cfe-out/РасширениеНовое1.cfe" существует
