...
Функционал: Проверка запуска и работы Vanessa-ADD
	Как Разработчик/Инженер по тестированию
	Я Хочу иметь возможность автоматической проверки запуска проверки через Vanessa-ADD
