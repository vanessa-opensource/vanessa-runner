...
Сценарий: Вызов приложения с выводом отладки в отдельный файл
    ...
    И Файл "debug.log" содержит "ОТЛАДКА - [o.app.vanessa-runner] - Подключил вывод отладочного лога в отдельный файл debug.log"
    И Вывод команды "oscript" не содержит "ОТЛАДКА - [o.app.vanessa-runner] - Подключил вывод отладочного лога в отдельный файл debug.log"
    И Код возврата команды "oscript" равен 0
