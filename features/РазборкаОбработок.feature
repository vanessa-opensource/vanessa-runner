...
Сценарий: Разборка одной внешней обработки с временной базой
    ...
    Когда Я выполняю команду "oscript" с параметрами "<КаталогПроекта>/src/main.os decompileepf build/out/fixture.epf epf"
...
Сценарий: Разборка каталога внешних обработок с временной базой
    ...
    Когда Я выполняю команду "oscript" с параметрами "<КаталогПроекта>/src/main.os decompileepf build/out epf"
